...
with open('/home/mohamed/myprojects/migliore2024/phasecoding/Apic1_Voltage_After_NetStim_Ran_On_20260206_1231/Soma_Voltage_After_NetStim_Ran_On_20260206_1231.csv', 'r') as f:
    reader = csv.reader(f)
    soma_apical_data = list(reader)
    
t_soma_apical_array = [float(row[0]) for row in soma_apical_data]
v_soma_apical_array = [float(row[1]) for row in soma_apical_data]

with open('/home/mohamed/myprojects/migliore2024/phasecoding/Soma_Voltage_After_NetStim_Ran_On_20260206_1231/Soma_Voltage_After_NetStim_Ran_On_20260206_1231.csv', 'r') as f:
    reader = csv.reader(f)
...
#plt.figure()
axes.plot(t_soma_apical_array, v_soma_apical_array, color='red')
...
axes.legend(["Soma w/ Apical Dendrite Stim", "Soma"])
#plt.show()
