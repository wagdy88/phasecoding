...
#define tau _ml->template fpfield<1>(_iml)
#define tau_columnindex 1
#define cai0 _ml->template fpfield<2>(_iml)
#define cai0_columnindex 2
#define cmax _ml->template fpfield<3>(_iml)
...
#define Dcai _ml->template fpfield<7>(_iml)
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	tau = _parm_default[1]; /* 100 */
 	cai0 = _parm_default[2]; /* 5e-05 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"tau"} /* 1 */,
                                       _nrn_mechanism_field<double>{"cai0"} /* 2 */,
                                       _nrn_mechanism_field<double>{"cmax"} /* 3 */,
                                       _nrn_mechanism_field<double>{"i"} /* 4 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 5 */,
                                       _nrn_mechanism_field<double>{"cai"} /* 6 */,
                                       _nrn_mechanism_field<double>{"Dcai"} /* 7 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 cacum /home/mohamed/myprojects/migliore2024/phasecoding/cacumm.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/mohamed/myprojects/migliore2024/phasecoding/cacumm.mod";
